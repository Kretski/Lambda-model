...
=========================================
STAGE 5I-32c (COARSE + FAST EARLY-EXIT) — FULL-RANGE CONTINUATION OF THE UNASSIGNED DEEP-POLE BRANCH
...
Output
------
  stage5I_32c_deep_branch_fast_m21_to_m4.csv
...
def main():
    print(sep)
    print("STAGE 5I-32c (COARSE + FAST EARLY-EXIT) — DEEP-POLE BRANCH CONTINUATION, m=-21 to -4")
    ...
    out_csv = HERE / "stage5I_32c_deep_branch_fast_m21_to_m4.csv"
