...
*Version: FINAL — all numbers frozen (July 2026 validation campaign, selection-rule-matched v2 injection sets; GW150914 twin residual resolved via tie-free raw-max accounting). DOI and GWOSC acknowledgment wording confirmed (September 2026). Remaining before submission: Section 5.4 table and text still report the original n=30 event-twin sets; the deposit's n=100 expansion (seeds 707/808/909, 2026-08-02) gives updated percentiles (GW170608 46th [36–56 CI], GW151226 1st [0–3 CI], GW150914 47th [37–57 CI]) that should replace them before submission.*
...
The coherence axis itself has direct historical precedent: CorrPower (Cadonati & Márka, CQG 2005) computed coherent power between detector pairs, maximized over time lags bounded by the inter-site light-travel time, and was deployed as an operational LIGO burst-search component across the S3–S5 science runs. Two gaps distinguish the present work. First, CorrPower's validation predates the first confirmed gravitational-wave detection: its published performance is characterized on simulated white Gaussian noise with a single injected morphology (1 ms Gaussian pulses), with no test against real detector noise, real astrophysical events, or multiple signal morphologies — the multi-morphology efficiency crossover reported in Section 5.2 (sine-Gaussian bursts recovered more efficiently than BBH signals at equal SNR) has no published counterpart for CorrPower or any comparable statistic. Second, CorrPower was measurably less sensitive than coherent WaveBurst (30–50% higher strain amplitude required for equivalent detection efficiency; LIGO-P080008) and appears not to have been carried into the O1–O4 era, superseded by fully coherent likelihood methods before real events existed to validate either approach against. The present statistic revisits this same simple-coherence family with the statistical apparatus (stratified global null, look-elsewhere-matched significance, bootstrap-uncertain injection recovery) that was never applied to it, against a catalog of real confirmed detections that did not exist when it was retired.

A second, contemporaneous use of inter-detector cross-correlation appears in Giri & Mukherjee (arXiv:2604.22441, April 2026), which computes a residual cross-correlation between H1 and L1 after waveform subtraction to search for three-body perturbation signatures in three long-duration GWTC-4 events — a different question (post-subtraction residual structure) applied to a different regime (long-duration signals) than the present detection-statistic validation on raw whitened strain.
...
One hundred rule-matched injections at each of three real-event parameter points (zero spin; random sky/orientation; SNR fixed to the catalog value; seeds 707/808/909), superseding the earlier n=30 sets:
...
GW170608 (12+7 M☉, SNR 15): the event sits at the 46th percentile [36th–56th 95% bootstrap CI] of its 100-twin population (median 0.325, range 0.180–0.464) — a typical detection. Twin efficiency above the null p99 threshold (0.284): 66%.

GW151226 (13.7+7.7 M☉, SNR 13): the event sits at the 1st percentile [0th–3rd CI] of its 100-twin population (median 0.285, range 0.193–0.405). The twin median (0.285) coincides with the null p99 detection threshold (0.284), directly confirming that SNR-13 light systems are a borderline population: 53% of twins exceed the detection threshold, and the real event fell in the undetected half. This is expected behavior under 53% efficiency, not an anomaly. One twin (seed 808, index 65) produced max_corr = 0.196, identical to the real event score, confirming the score is physically reachable. Twin efficiency above null p99: 53%, consistent with the event-twin efficiency of 40% ± 9% reported in the earlier n=30 analysis.

GW150914 (36+29 M☉, SNR 24): under score-selected accounting the event sits at the 5th percentile [1st–10th CI] of its 100-twin population — the tie-breaking artifact of Section 2 (both the event and every twin saturate the legacy clipped score at multiple offsets; the recorded value reflects grid-offset alignment, not source physics). Under tie-free raw-max accounting the event's raw maximum of 0.533 sits at the 47th percentile [37th–57th CI] of the twins' raw-max distribution (median 0.534, range 0.235–0.689) — unremarkable, and now established on n=100 rather than n=30. GW150914 has χ_eff ≈ −0.06; O1/O2 injections and null are statistically indistinguishable, excluding run-state and spin as explanations for the score-selected deficit. Twin efficiency above null p99: 98%, consistent with the SNR 18–30 band AUC of 0.991.

[Registered prediction "both twin deficits dissolve under the matched rule": CONFIRMED and strengthened at n=100 — GW151226 dissolved under rule matching, GW150914 under tie-free raw-max accounting.]
...
All scripts (analyzer V4/V5, global background v3, event comparison, local checks, span scan, injection recovery and analysis, figure generation), exact seeds (null: 42/43; injections: 101/202/303/404/505/606), the sampled epoch GPS lists (JSONL), and both pre- and post-fix injection sets (documenting error 5) are archived at Zenodo, doi:10.5281/zenodo.21435217 (concept DOI, resolves to the latest version; current version v2, doi:10.5281/zenodo.22210847, deposited 2026-08-31). GWOSC open data (O1/O2, 4 kHz strain). Software: Python 3.13, gwpy 4.0.1, PyCBC 2.11.0, NumPy 2.3.5, SciPy 1.16.3, gwosc 0.8.2, under WSL2 Ubuntu on consumer hardware (AMD Ryzen 7 PRO, 16 GB RAM).

## Acknowledgments

This research has made use of data or software obtained from the Gravitational Wave Open Science Center (gwosc.org), a service of the LIGO Scientific Collaboration, the Virgo Collaboration, and KAGRA. This material is based upon work supported by NSF's LIGO Laboratory, which is a major facility fully funded by the National Science Foundation, as well as the Science and Technology Facilities Council (STFC) of the United Kingdom, the Max-Planck-Society (MPS), and the State of Niedersachsen/Germany for support of the construction of Advanced LIGO and construction and operation of the GEO600 detector. Additional support for Advanced LIGO was provided by the Australian Research Council. Virgo is funded, through the European Gravitational Observatory (EGO), by the French Centre National de Recherche Scientifique (CNRS), the Italian Istituto Nazionale di Fisica Nucleare (INFN) and the Dutch Nikhef, with contributions by institutions from Belgium, Germany, Greece, Hungary, Ireland, Japan, Monaco, Poland, Portugal, Spain. KAGRA is supported by Ministry of Education, Culture, Sports, Science and Technology (MEXT), Japan Society for the Promotion of Science (JSPS) in Japan; National Research Foundation (NRF) and Ministry of Science and ICT (MSIT) in Korea; Academia Sinica (AS) and National Science and Technology Council (NSTC) in Taiwan. Data cited: R. Abbott et al. (LIGO Scientific Collaboration and Virgo Collaboration), "Open data from the first and second observing runs of Advanced LIGO and Advanced Virgo", SoftwareX 13 (2021) 100658. [Text current as of the GWOSC acknowledgment page checked September 2026; re-verify at gwosc.org/acknowledgement/ immediately before final deposit, as this text is periodically updated.]
