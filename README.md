...
| Component                                   | Status                                                                                                                                    |
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Numerical PDE solver (spatial)              | ✅ Exact (spectral method, machine precision)                                                                                              |
| Numerical PDE solver (temporal)             | ✅ Validated $O(1/N)$ convergence                                                                                                          |
| Discrete biharmonic operator $D_n^4$        | ✅ Validated $O(h^2)$ convergence                                                                                                          |
| $\Lambda$-recovery from noisy data          | ✅ Validated, sub-percent accuracy                                                                                                         |
...
│   ├── paper3_grid_convergence.py       # Temporal convergence + Lambda-recovery tests
...
silently. We consider this as important to publish as the positive
results.
